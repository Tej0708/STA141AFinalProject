...
### Part 4: Evaluation on Test sets:
...
The first thing I wanted to do was look at the variables that we will be working with. In this case there are 8 variables that are listed.
```{r echo=FALSE}
names(session[[1]])
```
...
mtext("Session 5 Trial 3 feedback", side = 1, line = 4.1, font = 1)
```
```{r echo=FALSE}
plot.trial(8,area, area.col,session[[i.s]])
mtext("Session 5 Trial 8 feedback", side = 1, line = 4.1, font = 1)
```
```{r echo=FALSE}
plot.trial(13,area, area.col,session[[i.s]])
mtext("Figure 2.3 Session 5 Trial 13 feedback", side = 1, line = 4.1, font = 1)
```

```{r echo=FALSE}
plot.trial(18,area, area.col,session[[i.s]])
mtext("Figure 2.4 Session 5 Trial 18 feedback", side = 1, line = 4.1, font = 1)

```
```{r echo=FALSE}
plot.trial(23,area, area.col,session[[i.s]])
mtext("Figure 2.5 Session 5 Trial 23 feedback", side = 1, line = 4.1, font = 1)
```
...
# Evalutation of Model on Test Set:
...
roc_curve <- roc(testing_y, predicted_probs)
...
- https://chat.openai.com/share/da8381c8-69fd-4fbb-8c04-462881534ceb
- https://chat.openai.com/share/f85f87c5-0628-4847-8b05-4353c41a2bff
2. Lecture Notes
3. Discussion Notes
